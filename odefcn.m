function dydt = odefcn(t, y, p_C, g_T, tau_C, alpha, omega_T, k, k_, psi_T, gamma_T, omega_G, psi, psi_g, gamma_g, h) 
...
%    h          timestep
    ...
    dydt(1) = ((p_C*y(1)*(y(2)+y(3)))/(g_T+(y(2)+y(3)))) - alpha*y(1)*y(2) - 1/tau_C * y(1);
    ...
    dydt(5) = psi*(dydt(3)+dydt(4))*heaviside(-(dydt(3)+dydt(4)))* y(5); % Heaviside requires symbolic maths toolbox
    % dydt = dydt *h;
end 